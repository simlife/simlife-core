...
const isReserved = require('../../../../lib/core/simlife/reserved_keywords').isReserved;
const isReservedClassName = require('../../../../lib/core/simlife/reserved_keywords').isReservedClassName;
const isReservedFieldName = require('../../../../lib/core/simlife/reserved_keywords').isReservedFieldName;
...
describe('ReservedKeywords', () => {
  describe('::isReserved', () => {
    ...
    describe('when passing a valid keyword', () => {
      it('returns false', () => {
        expect(isReserved('ValidKeyword', 'SIMLIFE')).to.be.false;
        expect(isReserved('ACCOUNT', 'JAVA')).to.be.false;
      });
    });
    describe('when passing an invalid simlife keyword, no matter the case', () => {
      it('returns true', () => {
        expect(isReserved('Account', 'SIMLIFE')).to.be.true;
        expect(isReserved('account', 'simlife')).to.be.true;
        expect(isReserved('ACCOUNT', 'SIMLIFE')).to.be.true;
        expect(isReserved('ACCOUNT', 'simlife')).to.be.true;
      });
