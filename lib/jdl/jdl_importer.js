...
const SimlifeApplicationExporter = require('../export/simlife_application_exporter');
const SimlifeEntityExporter = require('../export/simlife_entity_exporter');
...
function importOneApplicationAndEntities(jdlObject, configuration) {
  ...
  importState.exportedApplications.push(SimlifeApplicationExporter.exportApplication(application));
...
function importApplicationsAndEntities(jdlObject, configuration) {
  ...
  importState.exportedApplications = SimlifeApplicationExporter.exportApplications(jdlObject.applications);
  if (jdlObject.getEntityQuantity() !== 0) {
...
function exportJSONEntities(entities, configuration) {
  return SimlifeEntityExporter.exportEntities({
    entities,
...
function exportJSONEntitiesInApplications(entities, configuration, applications) {
  return SimlifeEntityExporter.exportEntitiesInApplications({
    entities,
    forceNoFiltering: configuration.forceNoFiltering,
    applications
  });
