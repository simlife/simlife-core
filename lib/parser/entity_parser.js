...
const RelationshipTypes = require('../core/simlife/relationship_types').RELATIONSHIP_TYPES;
...
const UnaryOptions = require('../core/simlife/unary_options').UNARY_OPTIONS;
const BinaryOptions = require('../core/simlife/binary_options').BINARY_OPTIONS;
const serviceClassOptionValue = require('../core/simlife/binary_options').BINARY_OPTION_VALUES.service.SERVICE_CLASS;
