...
const JSONEntity = require('../core/simlife/json_entity');
const ApplicationTypes = require('../core/simlife/application_types');
const FieldTypes = require('../core/simlife/field_types');
const RelationshipTypes = require('../core/simlife/relationship_types');
const DatabaseTypes = require('../core/simlife/database_types');
...
const UnaryOptions = require('../core/simlife/unary_options');
const BinaryOptions = require('../core/simlife/binary_options').Options;
const Validations = require('../core/simlife/validations');
const serviceClassOptionValue = require('../core/simlife/binary_options').Values.service.SERVICE_CLASS;
...
function initializeEntities() {
  for (let i = 0, entityNames = Object.keys(jdlObject.entities); i < entityNames.length; i++) {
     ...
     * created Simlife User entity and none of its fields and ownerside
    ...
    if (entityName.toLowerCase() === USER.toLowerCase()) {
      winston.warn('An Entity name \'User\' was used: \'User\' is an' +
        ' entity created by default by Simlife. All relationships toward' +
