...
Are you ready to contribute to Simlife core? We'd love to have you on board, and we will help you as much as we can. Here are the guidelines we'd like you to follow so that we can be of more help:
...
This is the Simlife core bug tracker, and it is used for [Issues and Bugs](#issue) and for [Feature Requests](#feature). It is **not** a help desk or a support forum.

If you have a question on using Simlife, or if you need help with your Simlife core project, please [read our help page](http://www.simlife.tech/help/) and use the [Simlife tag on StackOverflow](http://stackoverflow.com/tags/simlife) or join our [Gitter.im chat room](https://gitter.im/simlife/generator-simlife).

## <a name="issue"></a> Issues and Bugs
If you find a bug in the source code or a mistake in the documentation, you can help us by [submitting a ticket](https://opensource.guide/how-to-contribute/#opening-an-issue) to our [GitHub issues](https://github.com/simlife/simlife-core/issues). Even better, you can submit a Pull Request to our [Simlife core project](https://github.com/simlife/simlife-core) or to our [Documentation project](https://github.com/simlife/simlife.github.io).

**Please see the Submission Guidelines below**.

## <a name="feature"></a> Feature Requests
You can request a new feature by submitting a ticket to our [GitHub issues](https://github.com/simlife/simlife-core/issues). If you
...
Before you submit your issue search the [archive](https://github.com/simlife/simlife-core/issues?utf8=%E2%9C%93&q=is%3Aissue), maybe your question was already answered.
...
* **Versions** - Simlife version, Simlife core version and the editor

Click [here](https://github.com/simlife/simlife-core/issues/new) to open a bug issue with a pre-filled template. For feature requests and enquiries you can use [this template][feature-template].
...
* Search [GitHub](https://github.com/simlife/simlife-core/pulls?utf8=%E2%9C%93&q=is%3Apr) for an open or closed Pull Request
  that relates to your submission.
* In GitHub, send a pull request to `simlife/simlife-core:master`.
* If we suggest changes then
  * Make the required updates.
  * Re-run the Simlife core tests on your sample generated project to ensure tests are still passing.
